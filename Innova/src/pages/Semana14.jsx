...
import validado1 from '../img/Failed1.jpg';
import validado2 from '../img/failed2.jpg';
...
export default function Semana14() {
    ...
    const finalProduct = {
        ...
        // Convertir el link de YouTube a formato embed
        videoUrl: 'https://www.youtube.com/embed/feCwsBdXhms',
        features: [
    ...
    return (
        <div className="weekly-report-page">
            ...
            <section className="hero-main weekly-hero final-hero">
                ...
                <div className="hero-content container">
                    ...
                    <a href="#video-promo" className="btn primary final-cta">
                        <span>Ver Video Promocional</span>
            ...
            <div className="container">
                ...
                <section id="video-promo" className="video-section">
                    <div className="section-header centered">
                        ...
                        <p className="section-subtitle">
                            Visualiza la funcionalidad, el diseño y los beneficios clave del prototipo final, 
                            presentado como un anuncio profesional.
                        </p>
                    </div>
                ...
                <section className="final-product-section">
                    <div className="section-header">
                        ...
                        <p className="section-subtitle">
                            El modelo que superó todas las pruebas de impresión y cumple con los estándares 
                    ...
                    <div className="final-product-content">
                        <div className="final-product-image-wrapper card">
                            <img 
                                src={prototypes[3].image} 
                                alt="Producto Final V4.0" 
                                className="final-product-image"
                                loading="lazy"
                            />
                            <div className="final-badge">✓ VALIDADO</div>
                        </div>
                        
                        <div className="final-product-details">
                            <h3 className="final-name">{finalProduct.name}</h3>
                            <p className="final-desc">
                                El resultado del proceso iterativo. Tras tres fallos críticos, esta versión 
                                representa la culminación del diseño y la optimización de los parámetros de 
                                impresión 3D, listo para su producción.
                            </p>
                            ...
                            <div className="key-specs-list">
                                <div className="spec-item">
                                    ...
                                    <div>
                                        ...
                                        <span>PLA de Alta Resistencia</span>
                                    </div>
                                </div>
                                <div className="spec-item">
                                    ...
                                    <div>
                                        ...
                                        <span>FDM (Fused Deposition Modeling)</span>
                                    </div>
                                </div>
                                <div className="spec-item">
                                    <span className="spec-icon">⏱️</span>
                            ...
                            <a href="#prototypes" className="btn ghost final-cta">
                ...
                {/* GRID DE PROTOTIPOS */}
                <section id="prototypes" className="iteration-section">
                    <div className="section-header centered">
                        ...
                        <p className="section-subtitle">
                            Análisis detallado de cada una de las 4 pruebas de impresión, los problemas 
                            encontrados y las soluciones implementadas en el diseño o el laminado.
                        </p>
                    </div>

                    <div className="iteration-grid">
                        {prototypes.map((p, index) => (
                            <div key={index} className={`prototype-card card ${index === 3 ? 'final-version' : ''}`}>
                                <div className="prototype-header">
                                    <h3 className="prototype-version">{p.version}</h3>
                                    <p className="prototype-date">{p.date}</p>
                                    {index === 3 && <span className="success-badge">✓ ÉXITO</span>}
                                </div>

                                <div className="prototype-image-wrapper">
                                    <img src={p.image} alt={`Prototipo ${p.version}`} loading="lazy" />
                                    <div className="image-overlay">
                                        <span className="version-tag">{p.version}</span>
                                    </div>
                                </div>

                                <div className="prototype-details">
                                    <div className={`detail-block ${index === 3 ? 'success-block' : 'issue-block'}`}>
                                        <p className="detail-label">
                                            {index === 3 ? '✅ Validación:' : '🚫 Fallo Crítico:'}
                                        </p>
                                        <p className="detail-title">{p.issue}</p>
                                        <p className="detail-analysis"><strong>Análisis:</strong> {p.analysis}</p>
                                    </div>
                                    
                                    <div className="detail-block solution-block">
                                        <p className="detail-label">💡 Solución Implementada:</p>
                                        <p className="detail-desc">{p.solution}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
                ...
                <section id="conclusion" className="impact-section final-conclusion">
                    <div className="impact-content card">
                        <div className="section-header centered">
                            <span className="section-number">Cierre del Proyecto</span>
                            <h2>Conclusión y <em className="brand-text">Proyecciones</em></h2>
                        </div>
                        
                        <div className="conclusion-content">
                            <p className="impact-text">
                                La entrega del prototipo V4.0 marca la culminación de un ciclo de desarrollo riguroso. 
                                Hemos demostrado la capacidad de convertir un diseño conceptual en un producto físico 
                                funcional, resolviendo iterativamente los desafíos inherentes a la manufactura aditiva. 
                                El modelo final está listo para la validación de mercado y el escalamiento a una 
                                producción en lotes.
                            </p>
                            ...
                            <div className="conclusion-stats">
                                ...
                                <div className="stat-box">
                                    ...
                                    <span className="stat-label">Fallos Corregidos</span>
                                </div>
                                <div className="stat-box">
                                    <span className="stat-number">100%</span>
                                    <span className="stat-label">Validación Final</span>
                                </div>
                            </div>
                            
                            <div className="conclusion-cta-wrapper">
                                <a href="#video-promo" className="btn primary conclusion-cta">
                                    Revisar Video del Producto
                                </a>
                                <a href="#prototypes" className="btn ghost">
                                    Ver Iteraciones Anteriores
                                </a>
                            </div>
                        </div>
                    </div>
